# Vcyrus By Cyrus ( MOD ENGLISH )
```
* Vcyrus (Final Version OF VPS-MX 8.5x)
```
![logo](https://raw.githubusercontent.com/Cyrusagn/Vcyrus_English_Official/main/Vcyrus.png)
...
# Installation
```
rm -rf install-without-key.sh; apt update; apt install curl; apt install bc; wget https://github.com/Cyrusagn/Vcyrus_English_Official/raw/main/installer/install-without-key.sh; chmod 777 install-without-key.sh; ./install-without-key.sh --start

```


## :octocat: Translated and Modded by Cyrus
<ul>
 <li>TELEGRAM CHANNEL: https://t.me/Cyrusagn</li>
 <li>FACEBOOK: https://www.facebook.com/Cyrusagn.me</li>
 <li>INSTAGRAM: https://www.instagram.com/Cyrusagn</li>
 <li>TWITTER: https://www.instagram.com/Cyrus_agn</li>
