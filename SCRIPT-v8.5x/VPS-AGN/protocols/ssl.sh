...
echo -e "\033[1;32m $(fun_trans  "              SSL INSTALLER By Vcyrus")"
msg -bar
...
msg -bar
 ...
 sleep 3  
 screen -dmS pydic-80 python ${SCPinst}/python.py 80 "Vcyrus" && echo "80 Vcyrus" >> /etc/Vcyrus/PySSL.log
 msg -bar
 } 
 install_ssl(){  
...
msg -bar3
msg -tit
echo -e "${cor[3]}       MONO AND MULTI SSL INSTALLER By @CyrusAGN"
msg -bar
