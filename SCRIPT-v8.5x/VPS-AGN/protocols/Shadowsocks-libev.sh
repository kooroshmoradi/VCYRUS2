...
msg -bar
msg -tit
echo -e "${cor[3]}  SHADOWSOCK-LIBEV +(obfs) INSTALLER By @CyrusAGN"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/Cyrusagn/Vcyrus_English_Official/master/LINKS-LIBRARIES/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
