...
msg -bar
msg -tit
echo -e "${cor[3]}    SHADOWSOCK-R + (obfs)INSTALLER By @CyrusAGN"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/Cyrusagn/Vcyrus_English_Official/master/LINKS-LIBRARIES/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
