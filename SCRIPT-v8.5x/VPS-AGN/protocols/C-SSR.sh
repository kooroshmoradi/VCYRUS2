...
msg -bar
    echo -e " PANEL Vcyrus By @CyrusAGN"
...
msg -bar
	stty erase '^H' && read -p "(Default: Vcyrus):" ssr_user
	[[ -z "${ssr_user}" ]] && ssr_user="Vcyrus"
...
msg -bar
	stty erase '^H' && read -p "(Default: Vcyrus):" ssr_password
	[[ -z "${ssr_password}" ]] && ssr_password="Vcyrus"
...
clear
	SSR_installation_status
	echo && echo -e "    ###¿What do you want to do??###Mod By @CyrusAGN
$(msg -bar)
